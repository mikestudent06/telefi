...
const _Layout = () => {
    return (
        <Tabs screenOptions={{
            ...
            tabBarStyle: { backgroundColor: "#0f0D23", borderRadius: 50, marginHorizontal: 20, marginBottom: 46, height: 84, position: "absolute", overflow: "hidden", borderWidth: 1, borderColor: "0f0d23" }
        }}>
